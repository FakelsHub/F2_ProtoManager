...
#Region "Flags Ext"
    Public Property IsUse As Boolean
        Set(value As Boolean)
            proto.FlagsExt = If(value, proto.Flags Or Enums.FlagsExt.Use, proto.Flags And Not (Enums.FlagsExt.Use))
        End Set
        Get
    ...
    Public Property IsUseOn As Boolean
        Set(value As Boolean)
            proto.FlagsExt = If(value, proto.Flags Or Enums.FlagsExt.UseOn, proto.Flags And Not (Enums.FlagsExt.UseOn))
        End Set
        Get
    ...
    Public Property IsPickUp As Boolean
        Set(value As Boolean)
            proto.FlagsExt = If(value, proto.Flags Or Enums.FlagsExt.PickUp, proto.Flags And Not (Enums.FlagsExt.PickUp))
        End Set
        Get
    ...
    Public Property IsHiddenItem As Boolean
        Set(value As Boolean)
            proto.FlagsExt = If(value, proto.Flags Or Enums.FlagsExt.HiddenItem, proto.Flags And Not (Enums.FlagsExt.HiddenItem))
        End Set
        Get
