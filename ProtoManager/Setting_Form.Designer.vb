...
Partial Class Setting_Form
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.FolderBrowserDialog1.Description = "Select the folder where the editor will save the edited files."
        ...
        Me.ToolTip1.SetToolTip(Me.CheckBox3, "Automatically clear cache folder with extracted files. (for fast start of the pro" &
