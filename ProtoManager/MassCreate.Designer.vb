...
Partial Class MassCreate
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Create Prototype:"
        '
        'NumericUpDown1
        '
        ...
        Me.Label3.Text = "Pro file number:"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "Count pro files:"
        '
        'Label5
        '
        ...
        Me.Label5.Text = "Next FID index num:"
        '
        'FBDialog
        '
        ...
        Me.Text = "Mass Proto File Creator"
